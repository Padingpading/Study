...
//
//    /**
//     * 传入指定容量的构造方法，里面调用指定初始容量和增长系数的方法，
//     * 1、指定初始容量
//     * 2、增长系数默认为0,意味着每次数组扩容为原来的大小的2倍。
//     */
...
//
//     /**最终构造
//      *initialCapacity:指定数组的初始化容量
//      *capacityIncrement:数组容量的增长系数,为0,每次扩容为原来的2被
//     */
...
//                    initialCapacity);
//        ///初始容量,直接创建数组,在list会指向一个final static的空数组,在添加的时候才会扩容。
...
//                //新的容量小于数组实际存储的元素数量，一定不扩容，多出的元素置为null
//                elementData[i] = null;
//            }
//        }
